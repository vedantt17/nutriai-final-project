...
def build_pdf():
    ...
    story.append(
        para(
            "The implementation intentionally avoids heavyweight infrastructure in the live demo path. The app still demonstrates big-data patterns by scanning a 5,200-row offline snapshot, sketching allergen membership, embedding candidate text, and ranking thousands of safe records per profile.",
            styles["BriefBody"],
        )
    )
